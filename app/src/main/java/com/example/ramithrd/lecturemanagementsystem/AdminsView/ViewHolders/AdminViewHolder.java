package com.example.ramithrd.lecturemanagementsystem.AdminsView.ViewHolders;
...
import com.example.ramithrd.lecturemanagementsystem.AdminsView.Activities.AdminAddSessionActivity;
...
public class AdminViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView lecturerNameTxt;
    ...
    public AdminViewHolder(View itemView) {
        ...
        lecturerNameTxt = (TextView) itemView.findViewById(R.id.adm_lec_name_txt);
        moduleNameTxt = (TextView) itemView.findViewById(R.id.adm_module_name_txt);
        moduleIdTxt = (TextView) itemView.findViewById(R.id.adm_module_id_txt);
        startTimeTxt = (TextView) itemView.findViewById(R.id.adm_start_time_txt);
        endTimeTxt = (TextView) itemView.findViewById(R.id.adm_end_time_txt);
        venueTxt = (TextView) itemView.findViewById(R.id.adm_venue_txt);
        batchNameTxt = (TextView) itemView.findViewById(R.id.adm_batch_txt);

        updateLecSession = (Button) itemView.findViewById(R.id.update_adm_btn);
        cancelLecSession = (Button) itemView.findViewById(R.id.cancel_adm_btn);
    ...
    private void cancelLecture(Session lecToBeCancelled){
        ...
        if (position >= 0) {
            ...
            Call<Boolean> cancelSession = adminService.cancelSession(lecToBeCancelled.getSession_Id());
    ...
    private void updateLecture(Session lecSession){
        ...
        Intent updateIntent = new Intent(context.getApplicationContext(), AdminAddSessionActivity.class);
